...
let questionStorage = localStorage.getItem('questions');
...
let testProgram = {
  ...
  generateElement: function () {
    ...
    for (let i = 0; i < questionStorage.questions.length; i++) {

      let testBoxQuestion = document.createElement('div');
      let testQuestionH2 = document.createElement('h2');
      ...
      for (let y = 0; y < questionStorage.questions[i].answers.length; y++) {

        let answerBox = document.createElement('div');
        let formQuestionInput = document.createElement('input');
        let formQuestionLabel = document.createElement('label');
        ...
        let formQuestionAnswer = document.createElement('span');
...
$(function () {
  ...
  $result.on('click', function (e) {
    ...
    let rightAnsws = ["input_1_3", "input_2_3", "input_3_3"];
    let checkedIDs = $(':checked').map(function () {
      return this.id;
    });
