...
var testProgram = {
  ...
  createdTest: function createdTest() {
...
$(function () {
  ...
  $result.on('click', function (e) {
    ...
    if (checkedIDs.length !== rightAnsws.length || $(':checked', 'div.question_box1').length > 0 || $(':checked', 'div.question_box2').length > 0 || $(':checked', 'div.question_box3').length > 0) {
